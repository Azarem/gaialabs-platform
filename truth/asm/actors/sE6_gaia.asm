...
widestring_08DFEE [
  ...
  `[PRT:@widestring_08DE96]To defeat an enemy you[N][LU1:78]touch, [LU1:DA]about[N][LU1:F7][LU1:9D]under[N][LU1:11]Castle.[FIN]`   ;02
...
widestring_08E1EE [
  `[PRT:@widestring_08DE96][LU1:15][LU1:C2]- The[N][LU1:C]Friar can defeat[N][LU1:8C]in places a[N]sword [LU1:78]reach.[FIN][LU1:61]you've defeated[N]all the enemies[N]the [LU2:9B][LU1:EF]open up.[FIN]`   ;00
  `[PRT:@widestring_08DE96]Take away the obstacle[N]in front, and the back[N]appears. Remove the[N]blocking pillar.[FIN]`   ;01
  `[PRT:@widestring_08DE96]The switch on the [LU2:65][N]cannot be activated [N]by [LU1:FE]weight. [FIN]`   ;02
]
...
widestring_08E3A7 `[PRT:@widestring_08DE96]Will's [LU1:C2]is the [N][LU1:3C]Slider. Pass [N][LU1:DC]narrow corridors [N]using [LU1:D6]power. [FIN]Be careful not to[N]overlook the cracks[N]in the cliff.[FIN]`

widestring_08E428 `[PRT:@widestring_08DE96]Will's [LU1:C2]is the [N][LU2:31]Dash. Use [LU1:D6]to [N]climb hills and jump. [FIN]There are [LU1:B6]hills at[N]the [LU1:16]Wall of China.[N]Try everything.[FIN]`

widestring_08E4A4 `[PRT:@widestring_08DE96][LU1:15][LU1:C2]is [N]the Aura Barrier. It [N]puts a layer of Aura [N][LU1:6D]his body. [FIN]Enemies at the mountain [N][LU1:E5]are strong.If [N]you use [LU1:D6]power, [LU1:FE][N]battles [LU1:EF]be easier. [FIN]`
